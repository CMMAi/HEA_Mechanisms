...
We create our atom configuration with a dimension of **21x20x10** unit cells, were generated by `create_atoms`. The X, Y and Z axes of the simulation box were aligned with **[11-2], [111] and [1-10]** crystal directions, respectively. The simulation box was filled with 67,200 iron atoms.
